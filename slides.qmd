...
::: {.incremental}
- Did your last big story reach its audience mainly through a channel **you control**?
- Have you ever **framed** a story to maximize its reach on a specific platform?
- Have you already **questioned your reach figures** when a story over- or under-performed?
:::
:::
...
(function () {
  function addQR() {
    var t = document.querySelector('#title-slide');
    if (!t) { return setTimeout(addQR, 100); }
    if (t.querySelector('.qr-slides')) return;
    var wrap = document.createElement('div');
    wrap.className = 'qr-slides';
    wrap.style.cssText = 'text-align:center; color:white; margin: 0.4em auto 0;';
    var lbl = document.createElement('div');
    lbl.innerHTML = '<a href="https://tinyurl.com/cmpf2026" style="color:#B0C4DE; text-decoration:none; font-weight:700;">tinyurl.com/cmpf2026</a>';
    lbl.style.cssText = 'margin-bottom:0.35em; font-size:0.65em;';
    var qr = document.createElement('img');
    qr.src = 'assets/cmpf2026-qr.svg';
    qr.style.cssText = 'background:white; border-radius:8px; box-shadow:0 2px 12px rgba(0,0,0,0.4); display:inline-block;';
    wrap.appendChild(lbl);
    wrap.appendChild(qr);
    t.appendChild(wrap);
  }
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', addQR);
  } else {
    setTimeout(addQR, 50);
  }
})();
