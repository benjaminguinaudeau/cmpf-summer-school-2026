...
(function () {
  function addQR() {
    ...
    wrap.style.cssText = 'text-align:center; color:white; margin: 1.1em auto 0;';
    var qr = document.createElement('img');
    qr.src = 'assets/cmpf2026-qr.svg';
    qr.style.cssText = 'width:150px; height:150px; background:white; padding:8px; border-radius:8px; box-shadow:0 2px 12px rgba(0,0,0,0.4); display:inline-block;';
    ...
    lbl.style.cssText = 'margin-top:0.45em; font-size:0.62em;';
    wrap.appendChild(qr);
